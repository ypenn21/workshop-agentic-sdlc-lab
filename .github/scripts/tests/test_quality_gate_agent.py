...
try:
    ...
    import sys
    spec_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "quality_gate_agent.py"))
    spec = importlib.util.spec_from_file_location("quality_gate_agent", spec_path)
    module = importlib.util.module_from_spec(spec)
    sys.modules["quality_gate_agent"] = module
    spec.loader.exec_module(module)
    SeverityLevel = module.SeverityLevel
    ViolationCategory = module.ViolationCategory
    FailureDetail = module.FailureDetail
    QualityGateDecision = module.QualityGateDecision
    format_text_decision = module.format_text_decision
    evaluate_quality_gate = module.evaluate_quality_gate
