...
- **`jira-manage-ticket`** (`.agents/skills/jira-manage-ticket/SKILL.md`): Creates new Jira tickets and updates existing workitems (summary, description, priority, labels, assignee, transition status, comments) using `acli`.
